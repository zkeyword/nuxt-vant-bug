...
module.exports = {
  ...
  head: {
    titleTemplate:
      '%s - 蝉大师_专业APP推广和关键词大数据分析平台_权威的ASO与ASM优化方案',
    title: '蝉大师_专业APP推广和关键词大数据分析平台_权威的ASO与ASM优化方案',
    ...
    meta: [
      ...
      },
      {
        hid: 'keywords',
        name: 'keywords',
        content: 'ASO,ASO优化,APP推广,asm,蝉大师'
      },
      {
        hid: 'description',
        name: 'description',
        content:
          '蝉大师是国内兼具ios和android的最专业APP关键词大数据分析平台，提供苹果商城APP查询榜单数据和权威ASO、asm优化方案，为您的APP推广保驾护航。'
      }
    ],
